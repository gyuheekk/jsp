...
<div class="container">
  ...
  <hr/>
    ...
    <table class="table table-bordered text-center">
      ...
      <tr>
        <td colspan="2">
			    <button type="submit" class="btn btn-success mr-3 btn-sm">어플리케이션저장</button>
			    <a href="t3_ApplicationCheck.jsp" class="btn btn-primary mr-3">어플리케이션확인</a>
			    <a href="t3_ApplicationDelete.jsp" class="btn btn-danger mr-3">부분어플리케이션삭제</a>
		   </td>
		  </tr>
		 </table>
		</form>
