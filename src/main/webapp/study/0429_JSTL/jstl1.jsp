...
<div class="text-right">
    <button type="button" onclick="javascript:location.href='jstl2.jsp';">JSTL반복문</button>
  </div>
	...
	<p>사용예2 : (su3=100, su4=40)</p> <!-- 문자비교를 함(100과 40을 비교하는게 아니라, 1과 4를 비교함) -->
	...
	<div>1115. su3 ge su4 : <c:if test="${su3+0 ge su4+0}"> 1115.su3가 su4보다 크거나같다.</c:if></div>
	<div>1116. su3 le su4 : <c:if test="${su3+0 le su4+0}"> 1116.su3가 su4보다 작거나같다.</c:if></div>
	<br/>
	
	<div>예제 : URL에 jumsu를 QueryString방식으로 입력 후 학점을 구하시오</div>
	...
	<div>예제2: URL에 직급코드(code)를 QueryString방식으로 입력 후 직급명을 구하시오</div>
