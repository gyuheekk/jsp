...
<head>
  ...
  <script>
    ...
    function responseLogin() {
    	myform.loginFlag.value = "reponse";
    	myform.submit();
    }
...
<div class="container">
  ...
  <form name="myform" method="post" action="<%=request.getContextPath()%>/j0425/T13Ok">
  	...
  	<div>
  	  <input type="submit" value="Javascript로그인" onclick="javascriptLogin()" class="btn btn-success"/>
  	  <input type="submit" value="Response로그인" onclick="responseLogin()" class="btn btn-primary"/>
  	  <input type="submit" value="Request로그인" onclick="requestLogin()" class="btn btn-info"/>
  	</div>
