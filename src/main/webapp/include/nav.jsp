...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <!-- <a class="navbar-brand" href="http://192.168.50.60:9090/javaclass">Home</a> -->
  <a class="navbar-brand" href="http://192.168.50.60:9090/javaclass/Main">Home</a>
			    ...
			    <div class="dropdown">
			      ...
			      <div class="dropdown-menu">
			        ...
			        <a class="dropdown-item" href="ScrollStudy.st">스크롤 연습</a>
				      <a class="dropdown-item" href="ScrollPage.st">무한 스크롤</a>
