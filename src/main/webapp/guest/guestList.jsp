	  ...
	  <table class="table table-bordered">
	    ...
	    <tr>
	      ...
	      <td colspan="3">
	      	...
	      	<c:if test="${!empty vo.homePage && fn:length(vo.homePage)>10 && fn:indexOf(vo.email, '.') != -1}"><a href='' target='_blank'>${vo.homePage}</a></c:if>
	      	</td>
	    </tr>
	    <tr>
	      <th>방문소감</th>
...
<div class="text-center">
  <ul class="pagination justify-content-center">
	  <c:if test="${pag > 1}"><li class="page-item"><a class="page-link" href="${ctp}/GuestList?pag=1&pageSize=${pageSize}">첫페이지</a></li></c:if>
