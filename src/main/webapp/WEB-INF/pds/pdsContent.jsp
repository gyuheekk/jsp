...
<p><br/></p>
<div class="container">
	<h2 class="text-center"><a name="topMenu"></a>자료 내용 상세보기</h2>
	<br/>
		...
		<form name="starForm" id="starForm">
			<fieldset style="border:0px;">
				<div class="viewPoint m-0 b-0">
					<input type="radio" name="star" value="5" id="star1"><label for="star1"><i class="fa-solid fa-star"></i></label>
					<input type="radio" name="star" value="4" id="star2"><label for="star2"><i class="fa-solid fa-star"></i></label>
					<input type="radio" name="star" value="3" id="star3"><label for="star3"><i class="fa-solid fa-star"></i></label>
					<input type="radio" name="star" value="2" id="star4"><label for="star4"><i class="fa-solid fa-star"></i></label>
					<input type="radio" name="star" value="1" id="star5"><label for="star5"><i class="fa-solid fa-star"></i></label>
					: 별점을 선택해 주세요 ■
				</div>
			</fieldset>
			<div class="m-0 p-0">
    	...
    	<c:if test="${imsiIdx != vo.idx}">
	      <div class="row">
	        <div class="col ml-2">
	          ...
	          <c:if test="${vo.mid == sMid || sLevel == 0}"><a href="javascript:reviewDelete(${vo.idx})" title="리뷰삭제" class="badge badge-danger"><i class="fa-solid fa-trash"></i></a></c:if>
	          <a href="#" onclick="reviewReply('${vo.idx}','${vo.nickName}','${fn:replace(vo.content,newLine,'<br>')}')" title="댓글달기" data-toggle="modal" data-target="#myModal" class="badge badge-secondary"><i class="fa-solid fa-pen-to-square"></i></a>
	        </div>
	        <div class="col text-right mr-2">
	        	<c:forEach var="i" begin="1" end="${vo.star}" varStatus="iSt">
	        	  <font color="gold"><i class="fa-solid fa-star"></i></font>
	        	</c:forEach>
	        	<c:forEach var="i" begin="1" end="${5 - vo.star}" varStatus="iSt"><i class="fa-regular fa-star"></i></c:forEach>
	        </div>
	      </div>
      ...
      <c:if test="${!empty vo.replyContent}">
      	<div class="d-flex text-secondary">
      		...
      		<div class="mt-2 ml-2">${vo.replyNickName}
      			...
      			<c:if test="${vo.replyMid == sMid || sLevel == 0}"><a href="javascript:reviewReplyDelete(${vo.replyIdx})" title="댓글삭제" class="badge badge-danger"><i class="fa-solid fa-trash"></i></a></c:if>
						<br/>${vo.replyContent}
      		</div>
      	</div>
      </c:if>
  ...
  <!-- 위로가기 버튼 -->
  <h6 id="topBtn" class="text-right mr-3"><img src="${ctp}/images/top_arrow.gif" title="위로이동"/></h6>
</div>
<p><br/></p>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title"> >>리뷰에 댓글 달기</h4>
        ...
        <div class="modal-body">
          <form name="reviewReplyForm" class="was-vilidated">
          	<table class="table table-bordered">
          		<tr>
          			<th style="width:30%">원본글작성자</th>
          			<td style="width:70%"><span id="reviewReplyNickName"></span></td>
          		</tr>
          		<tr>
          			<th>원본글</th>
