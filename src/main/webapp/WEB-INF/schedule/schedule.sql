...
insert into schedule values (default, 'atom', '2024-05-4','업무', '기획팀 5월 정기총회');
insert into schedule values (default, 'hkd1234', '2024-05-9','업무', '소득세 신고서 작성');
insert into schedule values (default, 'atom', '2024-05-14','모임', '초등학교동창회');
...
insert into schedule values (default, 'atom', '2024-05-20','업무', '담당자 미팅');
insert into schedule values (default, 'hkd1234', '2024-05-20','모임', '가족모임');
insert into schedule values (default, 'atom', '2024-05-20','여행', '제주도여행');
...
insert into schedule values (default, 'atom', '2024-05-24','모임', '고등학교 동창회');
...
insert into schedule values (default, 'atom', '2024-06-25','모임', '가족모임');
insert into schedule values (default, 'hkd1234', '2024-06-25','업무', '프로젝트 토론');
insert into schedule values (default, 'atom', '2024-06-30','학습', '스프링 학습시작');
