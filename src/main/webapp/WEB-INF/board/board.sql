...
-- 부모글(10)의 댓글만 출력
select * from boardReply where boardIdx = 10;
select boardIdx,count(*) as replyCnt from boardReply where boardIdx = 10;

select * from board where idx = 10;
select *,(select count(*) from boardReply where boardIdx = 33) as replyCnt from board where idx = 10;
